...
#define DEFAULT_STATIC_IP_3 0
#define DEFAULT_STATIC_IP_4 200

#define DEFAULT_GATEWAY_IP_1 192
#define DEFAULT_GATEWAY_IP_2 168
#define DEFAULT_GATEWAY_IP_3 0
...
public:
  ...
  WiFiBootMode check() {
    bool btnOn = digitalRead(BTN_PIN) == LOW;
